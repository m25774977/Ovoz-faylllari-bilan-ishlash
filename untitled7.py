...
Original file is located at
    https://colab.research.google.com/drive/1QiAPejxZCVVE7-05AM4vqPBWzBGOtpkm
"""
...
# Example usage
wav_file_path = '/content/sunflower-street-drumloop-85bpm-163900 (1) (1).wav'  # Replace with your WAV file path
...
# Matnni belgilash
text = "Hayotdagi eng katta boylik, o'zini tushunish va do'stlar bilan bo'lgan samimiy munosabatlardir."
...
# Matnni belgilash
text = "Hayotdagi eng go'zal narsa — hozirgi lahzani qadrlashdir."
...
# Matnni belgilash
text = "Haqiqiy baxt – kichik narsalarda, oddiy daqiqalarda yashaydi."
